...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-primary-600 dark:bg-neutral-900 text-white">
      <div className="container-custom py-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.email')}:</strong> teamadvox@gmail.com
              </li>
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.phone')}:</strong> 033-244-1139
              </li>
              <li className="text-neutral-300 text-sm">
                <strong>{t('footer.address')}:</strong> Bengaluru, Karnataka, India
              </li>
            </ul>
        ...
        <div className="mt-8 pt-6 border-t border-primary-800 dark:border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-neutral-400">
              &copy; {new Date().getFullYear()} Advox. {t('footer.rights_reserved')}
            </p>
